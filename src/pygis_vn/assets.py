...
.tien-do { height:.28rem; margin:-.15rem 0 1.4rem; border-radius:2rem; background:var(--vien); overflow:hidden; }
.tien-do span { display:block; height:100%; border-radius:inherit; background:linear-gradient(90deg,var(--xanh),#40c057); }
.hop-hoc { display:flex; align-items:center; justify-content:space-between; gap:1rem; margin:1.25rem 0 2rem;
  padding:1rem 1.1rem; border:1px solid var(--vien); border-radius:.85rem;
  background:linear-gradient(135deg,color-mix(in srgb,var(--la) 45%,var(--mat)),var(--mat)); }
.hop-hoc strong,.hop-hoc span { display:block; }
.hop-hoc span { color:var(--phu); font-size:.88rem; }
...
.anh-hung .dan-nhap { font-size:1.17rem; line-height:1.7; }
.anh-hung .loi-moi { margin-top:1rem; font-size:.95rem; }
.loi-moi a { font-weight:750; }
...
.nut.nho { margin:0; padding:.58rem .8rem; font-size:.82rem; white-space:nowrap; }
...
.cac-phan { display:grid; gap:2.6rem; }
.phan-ebook { display:grid; grid-template-columns:12rem minmax(0,1fr); gap:1.5rem; align-items:start; }
.tieu-de-phan { position:sticky; top:6rem; padding-top:.2rem; }
.tieu-de-phan span { color:var(--xanh-dam); font-size:.75rem; font-weight:850; letter-spacing:.12em; }
.tieu-de-phan h3 { margin:.25rem 0; font-size:1.25rem; }
.tieu-de-phan p,.mo-ta-muc { margin:0; color:var(--phu); }
.luoi-chuong { display:grid; grid-template-columns:repeat(2,1fr); gap:1rem; }
...
.the-chuong b { display:block; margin-top:1rem; color:var(--xanh-dam); font-size:.82rem; }
.the-chuong i { font-style:normal; transition:margin .15s; }
.the-chuong:hover i { margin-left:.25rem; }
.cach-hoc { display:grid; grid-template-columns:repeat(3,1fr); gap:1rem; }
.cach-hoc>div { padding:1.35rem; border-top:.2rem solid var(--xanh); background:var(--mat); }
.cach-hoc span { color:var(--xanh-dam); font-weight:850; font-size:.76rem; }
.cach-hoc h2 { margin:.4rem 0; font-size:1.15rem; }
.cach-hoc p { margin:0; color:var(--phu); font-size:.9rem; }
.trang-hoc { max-width:68rem; padding-top:4rem; }
.goi-y-lon { display:flex; align-items:center; justify-content:space-between; gap:2rem; margin:2.5rem 0 4rem;
  padding:2rem; border-radius:1.2rem; color:white; background:linear-gradient(135deg,#075c46,#0ca678);
  box-shadow:0 24px 60px #087f5b35; }
.goi-y-lon strong { text-transform:uppercase; letter-spacing:.08em; font-size:.72rem; color:#b7e4c7; }
.goi-y-lon h2 { margin:.25rem 0; }
.goi-y-lon p { margin:0; max-width:52ch; color:#e6fcf5; }
.goi-y-lon .nut { flex:none; background:white; color:#075c46; }
.buoc-hoc { display:grid; grid-template-columns:repeat(4,1fr); gap:1rem; margin-bottom:4rem; }
.buoc-hoc>div { padding:1.2rem; border:1px solid var(--vien); border-radius:.8rem; background:var(--mat); }
.buoc-hoc b { display:grid; place-items:center; width:2rem; height:2rem; border-radius:50%;
  color:white; background:var(--xanh); }
.buoc-hoc h2 { font-size:1rem; margin:.8rem 0 .3rem; }
.buoc-hoc p { margin:0; color:var(--phu); font-size:.86rem; }
.yeu-cau { margin:0 0 4rem; padding:1.5rem 2rem; border:1px solid var(--vien);
  border-radius:1rem; background:var(--mat); }
@media (max-width: 980px) {
  .bo-cuc { grid-template-columns:14rem minmax(0,1fr); } .muc-trang { display:none; }
  .buoc-hoc { grid-template-columns:repeat(2,1fr); }
}
@media (max-width: 720px) {
  ...
  .phan-ebook { grid-template-columns:1fr; } .tieu-de-phan { position:static; }
  .luoi-chuong,.cach-hoc,.buoc-hoc { grid-template-columns:1fr; }
  .dieu-huong { grid-template-columns:1fr; } .hop-hoc,.goi-y-lon { align-items:flex-start; flex-direction:column; }
