...
Chúng tôi cam kết xây dựng môi trường học tập cởi mở, an toàn và tôn trọng.

## Hành vi được khuyến khích

- Góp ý vào nội dung và mã, không công kích cá nhân.
- Kiên nhẫn với người mới học.
- Nêu nguồn và giới hạn của dữ liệu.
- Tôn trọng khác biệt chuyên môn, vùng miền và trải nghiệm.
- Chủ động sửa sai khi có bằng chứng tốt hơn.
